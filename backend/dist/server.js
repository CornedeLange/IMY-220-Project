...
function _connect() {
  _connect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee25() {
    return _regeneratorRuntime().wrap(function _callee25$(_context25) {
      while (1) switch (_context25.prev = _context25.next) {
        ...
        case 7:
          ...
          console.error("Failed to connect to MongoDB", _context25.t0);
        case 10:
        case "end":
...
app.put("/profile/:userId", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        ...
        case 15:
          ...
          console.error("Failed to retrieve friends", _context11.t0);
          res.status(500).send("Internal server error");
        case 19:
        case "end":
...
app.post("/createPlaylist", /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(req, res) {
    var _req$body3, playlistName, genre, description, hashtags, userId, coverImage, playlistId, newPlaylist, playListCollection, result, userCollection;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          _req$body3 = req.body, playlistName = _req$body3.playlistName, genre = _req$body3.genre, description = _req$body3.description, hashtags = _req$body3.hashtags, userId = _req$body3.userId;
          coverImage = req.file ? req.file.path : req.body.coverImage;
          if (!(!playlistName || !genre || !description || !userId)) {
            _context12.next = 4;
            break;
          }
          return _context12.abrupt("return", res.status(400).send("Playlist name, genre and description are required"));
        case 4:
          _context12.prev = 4;
        ...
        case 9:
          playListCollection = _context12.sent;
          _context12.next = 12;
        ...
        case 20:
          ...
          console.error("Failed to create playlist", _context12.t0);
          //res.status(500).send("Internal server error");
          res.status(500).json({
            message: "Internal server error"
          });
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 13:
          ...
          console.error("Failed to retrieve playlist", _context13.t0);
          //res.status(500).send("Internal server error");
          res.status(500).json({
            message: "Internal server error"
          });
...
app.post("/playlist/:playlistId/comment", /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(req, res) {
    var playlistId, _req$body4, userId, comment, result, newComment;
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          playlistId = req.params.playlistId;
          _req$body4 = req.body, userId = _req$body4.userId, comment = _req$body4.comment;
          if (!(!userId || !comment)) {
            _context14.next = 4;
            break;
          }
        ...
        case 18:
          ...
          console.error("Failed to add comment", _context14.t0);
          //res.status(500).send("Internal server error");
          res.status(500).json({
            message: "Internal server error"
          });
...
app.post("/playlist/:playlistId/song", /*#__PURE__*/function () {
  var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(req, res) {
    var playlistId, _req$body5, name, artist, link, addedBy, songId, songResult, playlistResult;
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        case 0:
          playlistId = req.params.playlistId;
          _req$body5 = req.body, name = _req$body5.name, artist = _req$body5.artist, link = _req$body5.link, addedBy = _req$body5.addedBy;
        ...
        case 11:
          playlistResult = _context15.sent;
...
app.put("/playlist/:playlistId", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          ...
          return getPlaylistCollection();
        case 5:
          playlistCollection = _context16.sent;
          _context16.next = 8;
        ...
        case 12:
          ...
          console.error("Failed to update playlist", _context16.t0);
          res.status(500).json({
            success: false,
            message: "Internal server error"
          });
    ...
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        ...
        case 8:
          ...
          console.error("Failed to retrieve song", _context18.t0);
          res.status(500).send("Internal server error");
        case 12:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee19$(_context19) {
      while (1) switch (_context19.prev = _context19.next) {
        ...
        case 9:
          ...
          console.error("Failed to delete song from playlist", _context19.t0);
          res.status(500).send("Internal server error");
        case 13:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee20$(_context20) {
      while (1) switch (_context20.prev = _context20.next) {
        ...
        case 7:
          ...
          console.error("Failed to retrieve songs", _context20.t0);
          res.status(500).send("Internal server error");
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee21$(_context21) {
      while (1) switch (_context21.prev = _context21.next) {
        ...
        case 7:
          ...
          console.error("Failed to retrieve playlists", _context21.t0);
          res.status(500).send("Internal server error");
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee22$(_context22) {
      while (1) switch (_context22.prev = _context22.next) {
        ...
        case 7:
          ...
          console.error("Failed to retrieve profiles", _context22.t0);
          res.status(500).send("Internal server error");
        case 11:
        case "end":
...
app.post("/addSongToWebsite", /*#__PURE__*/function () {
  var _ref23 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee23(req, res) {
    var _req$body6, name, artist, link, addedBy, songId, result, user;
    return _regeneratorRuntime().wrap(function _callee23$(_context23) {
      while (1) switch (_context23.prev = _context23.next) {
        case 0:
          _req$body6 = req.body, name = _req$body6.name, artist = _req$body6.artist, link = _req$body6.link, addedBy = _req$body6.addedBy;
          if (!(!name || !artist || !link || !addedBy)) {
            _context23.next = 3;
            break;
          }
        ...
        case 15:
          ...
          console.error("Failed to add song", _context23.t0);
          res.status(500).json({
            message: "Internal server error"
          });
        case 19:
...
}).on('close', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee24() {
